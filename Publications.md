...
<b>[10]</b>. Chen, Z. (Presenter), Song, Y., <b>Liu, Y. </b>, and Sebe, N. (2024). A lie group approach to Riemannian batch normalization. <i>Poster presentation given at the International Conference on Learning Representations.</i> Vienna, Austria, May.
<b>[11]</b>. <b>Liu, Y. </b>, Grimaldi, N., Basnet, N., Wozniak, D., Chen, E., Zahabi, M., Kaber, D., and Ruiz, J.. (Presenter) (2024). Classifying cognitive workload using machine learning techniques and non-intrusive wearable devices. <i>Oral presentation given at the IEEE International Conference on Human-Machine Systems. </i>Toronto, Canada, May. 
<b>[12]</b>. Grimaldi, N., <b>Liu, Y. </b>, McKendrick, R., Ruiz, J. (Presenter), and Kaber, D. (2024). Deep learning forecast of cognitive workload using fNIRS data. <i>Oral presentation given at the IEEE International Conference on Human-Machine Systems.</i> Toronto, Canada, May. 
